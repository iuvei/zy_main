...
Route::group('ssc', function () {
    ...
    Route::post('order2', 'cqssc/SscOrder/save2');
...
Route::group('pk10', function () {
    ...
    Route::post('order2', 'pk10/Pk10Order/save2');
...
Route::group('egg', function () {
    ...
    Route::post('order2', 'egg/EggOrder/save2');
...
Route::group('cake', function () {
    ...
    Route::post('order2', 'cake/CakeOrder/save2');
