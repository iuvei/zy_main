...
class TestController extends Controller
{
    ...
    {
        $a = ['pk10' => Pk10CustomOdds::class, 'pcegg' => EggCustomOdds::class, 'cqssc' => SscCustomOdds::class, 'cake' => CakeCustomOdds::class];
    ...
    public function delParams(Request $request)
    {
        $params = $request->only(['a', 'b', 'c'], 'delete');
        dump($params);
    }
}
